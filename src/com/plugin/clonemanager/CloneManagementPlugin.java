 ...
 */
public class CloneManagementPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "CloneManager"; //$NON-NLS-1$

	// The shared instance
	private static CloneManagementPlugin plugin;
	private static Initializer init;

	/**
	 * The constructor
	 */
	public CloneManagementPlugin() {
		super();
		if (plugin != null)
	 ...
	 */
	public static CloneManagementPlugin getDefault() {
		return plugin;
	}
